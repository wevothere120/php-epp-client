...
class eppCreateDomainTest extends eppTestCase {
    ...
    public function testCreateDomainWithoutAuthcode() {
        ...
        $this->assertInstanceOf('Metaregistrar\EPP\eppCreateDomainResponse',$response);
        /* @var $response Metaregistrar\EPP\eppCreateDomainResponse */
        $this->setExpectedException('Metaregistrar\EPP\eppException',"Error 2001: Command syntax error; value:line: 2 column: 276 cvc-complex-type.2.4.b: The content of element 'domain:create' is not complete. One of '{\"urn:ietf:params:xml:ns:domain-1.0\":contact, \"urn:ietf:params:xml:ns:domain-1.0\":authInfo}' is expected.");
